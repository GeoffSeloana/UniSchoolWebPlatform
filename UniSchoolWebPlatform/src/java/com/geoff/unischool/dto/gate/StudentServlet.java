 ...
 */
package com.geoff.unischool.dto.gate;

import com.geoff.unischool.dto.transfer.RequestDTO;
import com.geoff.unischool.dto.transfer.ResponseDTO;
import com.geoff.unischool.dto.util.DataUtil;
import com.geoff.unischool.dto.util.StudentUtil;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            switch(req.getRequestType()){
                case RequestDTO.GET_NEWS_BY_SCHOOL:
                    resp = studentUtil.getNewsBySchool(req.getSchoolID(),dataUtil);
                    break;
                case RequestDTO.GET_NEWS_BY_GRADE:
                    resp = studentUtil.getNewsByGrade(req.getGradeID(),dataUtil);
                    break;
